...
urlpatterns = [
    ...
    path('patientMakeAppointments/',MakeAppointments,name='patientMakeAppointments'),
    ...
    path('viewappointment/<int:appointment_id>/', appointment_detail, name='viewappointment'),
]
